...
public class IndexController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {	
		...
		List<Ebook> ebookList = this.ebookDao.selectEbookListByPage(beginRow, rowPerPage, categoryName); // 페이징한 ebookList 생성
		List<Ebook> searchEbookList = this.ebookDao.searchEbookList(beginRow, rowPerPage, searchWord); // 페이징한 ebookList 생성
		// View forward
		...
		request.setAttribute("searchEbookList", searchEbookList);
		...
		RequestDispatcher rd1 = request.getRequestDispatcher("/WEB-INF/view/ebook/categoryEbookList.jsp");//index페이지에서 category를 선택하면 categoryEbookList로 전송
